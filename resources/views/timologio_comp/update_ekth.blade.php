...
@section('formsdetails')
    <form id="update_ekth_from_tim_comp_form" method="post" action="{{ route('timol_compl.store_ekth',$timologio->id_timologio) }}" autocomplete="off">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header-cust">
                        <h4 class="heading-small text-center text-muted">
                            <strong>{{ __('Τιμολόγηση Εκθέσεων Εταιρείας') }}</strong>
                        </h4>
                    </div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input name="Date_ekdosis" type="hidden" value="{{ $timologio->Date_ekdosis }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-label{{ $errors->has('Parakratisi') ? ' has-danger' : '' }}">
                                    ...
                                    <select class="form-control form-select" id="Parakratisi" name="Parakratisi" disabled>
                                        <option value="Ναι"  @if($timologio->Parakratisi == "Ναι") selected="selected" @endif>Ναι</option>
                                        <option value="Όχι" @if($timologio->Parakratisi == "Όχι") selected="selected" @endif>Όχι</option>
                                    </select>
                                        ...
                                        <?php $count=0?>
                                            @foreach($status as $stat)
                                                @foreach($pragma as $pragm)
                                                    @if ($stat->id_ekthesis == $pragm->id_ekthesis)
                                                        <?php $count++ ?>
                                                    @endif
                                                @endforeach
                                            @endforeach
