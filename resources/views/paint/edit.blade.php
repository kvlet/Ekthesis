    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <form id="edit_paint_form" method="post" action="{{ route('paint.update',$pain->id_paint_type) }}" autocomplete="off">
                    @csrf
                    {{ method_field('PUT') }}
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-label{{ $errors->has('id_paint_type') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="id_paint_type" id="id_paint_type"
                                                   ...
                                                   value="{{ $pain->id_paint_type }}" autofocus disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-label{{ $errors->has('paint_type') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="paint_type" id="paint_type"
                                                   ...
                                                   value="{{ $pain->paint_type }}" autofocus required>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div class="row mt-4">
                                    <div class="col">
                                        <div class="text-center">
                                            <a href="{{ route('paint.create') }}"><img width="50" src="/images/add_rec.jpg" /></a> {{--onMouseOut="this.src='/images/add_rec.jpg'" onMouseOver="this.src='/images/logo.jpg'" --}}
                                        </div>
                                    </div>
