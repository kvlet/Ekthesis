                                    ...
                                    <div class="col-md-5">
                                        <div class="form-label{{ $errors->has('Cost_part') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="number" name="Cost_part" id="Cost_part"
                                                   ...
                                                   value="{{ $detail->pivot->Cost_part }}"  required autofocus disabled>
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-label{{ $errors->has('fpa_part') ? ' has-danger' : '' }}">
                                            ...
                                            <select class="form-control form-select" id="fpa_part" name="fpa_part">
                                                <option value="0" @if($detail->pivot->fpa_part==0)selected="selected" @endif disabled>Χωρίς Φ.Π.Α.</option>
                                                <option value="1" @if($detail->pivot->fpa_part==1)selected="selected" @endif disabled>Με Φ.Π.Α.</option>
                                            </select>
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-label{{ $errors->has('fpa_job') ? ' has-danger' : '' }}">
                                            ...
                                            <select class="form-control form-select" id="fpa_job" name="fpa_job" >
                                                <option value="0" @if($detail->pivot->fpa_job==0)selected="selected" @endif disabled>Χωρίς Φ.Π.Α.</option>
                                                <option value="1" @if($detail->pivot->fpa_job==1)selected="selected" @endif disabled>Με Φ.Π.Α.</option>
                                            </select>
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-label{{ $errors->has('quan') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="number" name="quan" id="quan"
                                                   ...
                                                   value="{{ $detail->pivot->quan }}"  autofocus disabled>
                                            @if ($errors->has('quan'))
                                                <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-label{{ $errors->has('Type') ? ' has-danger' : '' }}">
                                            ...
                                            <select class="form-control form-select" id="Type" name="Type" >
                                                <option value=" " @if($detail->pivot->Type== null)selected="selected" @endif disabled> </option>
                                                <option value="Γνήσιο" @if($detail->pivot->Type=='Γνήσιο')selected="selected" @endif disabled>Γνήσιο</option>
                                                <option value="Μεταχειρισμένο" @if($detail->pivot->Type=='Μεταχειρισμένο')selected="selected" @endif disabled>Μεταχειρισμένο</option>
                                                <option value="Μεταχειρισμένο Κομπλέ" @if($detail->pivot->Type=='Μεταχειρισμένο Κομπλέ')selected="selected" @endif disabled>Μεταχειρισμένο Κομπλέ</option>
                                                <option value="Ιμιτασιόν" @if($detail->pivot->Type=='Ιμιτασιόν')selected="selected" @endif disabled>Ιμιτασιόν</option>
                                            </select>
                                            @if ($errors->has('Type'))
                                                <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-label{{ $errors->has('diax_fr_b') ? ' has-danger' : '' }}">
                                            ...
                                            <select class="form-control form-select" id="diax_fr_b" name="diax_fr_b" >
                                                ...
                                                <option value="Ε" @if($detail->pivot->diax_fr_b=='Ε') selected="selected" @endif disabled>Ε</option>
                                                <option value="Ο" @if($detail->pivot->diax_fr_b=='Ο') selected="selected" @endif disabled>Ο</option>
                                            </select>
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-label{{ $errors->has('prod_code') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="prod_code" id="prod_code"
                                                   ...
                                                   value="{{ $detail->pivot->prod_code }}"  autofocus disabled>
