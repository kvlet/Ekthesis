...
@section('formsdetails')
    <form id="create_involv_cars_ekth_form" method="post" action="{{ route('pragmatognomosines.destroy_involv_cars',$id_ekthesis) }}" autocomplete="off">
        @csrf
        {{ method_field('DELETE') }}
        <div class="row">
            <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class="form-label{{ $errors->has('id_company') ? ' has-danger' : '' }}">
                                    ...
                                    <select class="form-control form-select" id="id_company" name="id_company" disabled>
                            ...
                            <div class="col-md-4">
                                <div class="form-label{{ $errors->has('xiliometra') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="xiliometra" id="xiliometra"
                                           ...
                                           value="{{ $inv_car->pivot->xiliometra }}" autofocus disabled>
                            ...
                            <div class="col-md-4">
                                <div class="form-label{{ $errors->has('value_car') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="value_car" id="value_car"
                                           ...
                                           value="{{ $inv_car->pivot->value_car }}" autofocus disabled>
                            ...
                            <div class="col-md-4">
                                <div class="form-label{{ $errors->has('driver') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="driver" id="driver"
                                           ...
                                           value="{{ $inv_car->pivot->driver }}" autofocus disabled>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-label{{ $errors->has('note') ? ' has-danger' : '' }}">
                                    ...
                                    <div id="note">
                                        <textarea id="note" name="note" style="width: 500px; height: 200px;" disabled
