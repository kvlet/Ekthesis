    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <form id="edit_proiparx_ekth_form" method="post" action="{{ route('pragmatognomosines.update_proiparxouses',$id_ekthesis) }}" autocomplete="off">
                    @csrf
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-label{{ $errors->has('value') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="number" name="value" id="value"
                                                   ...
                                                   value="{{ $proiparx->pivot->value }}"  autofocus required>
                                            @if ($errors->has('value'))
                                                <span class="invalid-feedback" role="alert">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-label{{ $errors->has('sint_fpa_job') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="number" name="sint_fpa_job" id="sint_fpa_job"
                                                   ...
                                                   value="{{ $proiparx->pivot->sint_fpa_job }}"  autofocus placeholder="24.00">
