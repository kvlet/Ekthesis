...
@section('formsdetails')
    <form id="edit_foto_ekth_form"  method="post" action="{{ route('pragmatognomosines.destroy_foto_ekth',$id_ekthesis) }}" autocomplete="off">
        @csrf
        {{ method_field('DELETE') }}
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-2">
                                ...
                                <input name="id_oximata" type="hidden" value="{{ $fotos->id_oximata }}">
                                <input name="id_person" type="hidden" value="{{ $fotos->id_person }}">
                                <input name="print_group" type="hidden" value="{{ $fotos->print_group }}">
                                <input name="notes" type="hidden" value="{{ $fotos->notes }}">
                            ...
                            <div class="col-md-2">
                                <div class="form-label{{ $errors->has('id_oximata') ? ' has-danger' : '' }}">
                                    ...
                                    <select class="form-control form-select" id="id_oximata" name="id_oximata" required disabled>
                            ...
                            <div class="col-md-2">
                                <div class="form-label{{ $errors->has('print_group') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="print_group" id="print_group"
                                           ...
                                           value="{{ $fotos->print_group }}"  autofocus disabled>
                            ...
                            <div class="col-md-4">
                                <div class="form-label{{ $errors->has('notes') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="notes" id="notes"
                                           ...
                                           value="{{ $fotos->notes }}"  autofocus disabled>
                                    @if ($errors->has('notes'))
                                        <span class="invalid-feedback" role="alert">
