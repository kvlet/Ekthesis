...
@section('formsdetails')
    <form id="edit_expen_ekth_form" method="post" action="{{ route('pragmatognomosines.update_expen_ekth',$id_ekthesis) }}" autocomplete="off">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                            ...
                            <div class="col-md-4">
                                <div class="form-label{{ $errors->has('Value') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="Value" id="Value"
                                           ...
                                           value="{{ $expen_ekth->pivot->Value }}"  autofocus required>
                                    @if ($errors->has('Value'))
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-md-4">
                                <div class="form-label{{ $errors->has('Quan') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="Quan" id="Quan"
                                           ...
                                           value="{{ $expen_ekth->pivot->Quan }}"  autofocus placeholder="1">
                                    @if ($errors->has('Quan'))
                                        <span class="invalid-feedback" role="alert">
