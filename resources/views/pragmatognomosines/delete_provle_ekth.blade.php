...
@section('formsdetails')
    <form id="delete_provlepseis_ekth_form" method="post" action="{{ route('pragmatognomosines.destroy_provlep_ekth',$id_ekthesis) }}" autocomplete="off">
        @csrf
        {{ method_field('DELETE') }}
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <input name="Date_provl" type="hidden" value="{{ $provlepseis->Date_provl }}">
                                <input name="Amount" type="hidden" value="{{ $provlepseis->Amount }}">
                            ...
                            <div class="col-md-3">
                                <div class="form-label{{ $errors->has('Date_provl') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="Date_provl" id="Date_provl" data-provide="datepicker" data-date-format="dd-mm-yyyy" placeholder="HH-MM-YYYY"
                                           ...
                                           value="{{ $provlepseis->Date_provl }}" required disabled>
                            ...
                            <div class="col-md-3">
                                <div class="form-label{{ $errors->has('Amount') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="Amount" id="Amount"
                                           ...
                                           value="{{ $provlepseis->Amount }}" autofocus required disabled>
                                </div>
                            </div>
                        </div>
                        <div class="row">
