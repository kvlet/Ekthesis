...
@section('formsdetails')
    <form id="delete_status_ekth_form" method="post" action="{{ route('pragmatognomosines.destroy_status_ekth') }}" autocomplete="off">
        @csrf
        {{ method_field('DELETE') }}
        <div class="row">
            <div class="col-md-12">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input name="Process_date" type="hidden" value="{{ $status_ekth->pivot->Process_date }}">
                                <input name="Notes" type="hidden" value="{{ $status_ekth->pivot->Notes }}">
                            ...
                            <div class="col-md-4">
                                <div class="form-label{{ $errors->has('Process_date') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="Process_date" id="Process_date" data-provide="datepicker" data-date-format="dd-mm-yyyy" placeholder="HH-MM-YYYY"
                                           ...
                                           value="{{ $status_ekth->pivot->Process_date }}" disabled>
                                    <script type="text/javascript">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-label{{ $errors->has('Notes') ? ' has-danger' : '' }}">
                                    ...
                                    <div id="Note">
                                        <textarea id="Notes" name="Notes" style="width: 500px; height: 200px;" disabled
