...
@section('formsdetails')
    <form id="delete_expen_partner_ekth_form" method="post" action="{{ route('pragmatognomosines.destroy_expen_partner_ekth',$id_ekthesis) }}" autocomplete="off">
        @csrf
        {{ method_field('DELETE') }}
        <div class="row">
            <div class="col-md-12">
                            ...
                            <div class="col-md-3">
                                <div class="form-label{{ $errors->has('value') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="value" id="value"
                                           ...
                                           value="{{ $expen_ekth_part->value }}"  autofocus required disabled>
                                    @if ($errors->has('value'))
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-md-3">
                                <div class="form-label{{ $errors->has('quan') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="quan" id="quan"
                                           ...
                                           value="{{ $expen_ekth_part->quan }}"  autofocus placeholder="1" disabled>
                                    @if ($errors->has('quan'))
                                        <span class="invalid-feedback" role="alert">
