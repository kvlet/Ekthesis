...
@section('formsdetails')
    <form id="delete_keimena_ekth_form" method="post" action="{{ route('pragmatognomosines.destroy_keimena_ekth') }}" autocomplete="off">
        @csrf
        {{ method_field('DELETE') }}
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-label{{ $errors->has('Print') ? ' has-danger' : '' }}">
                                    ...
                                    <select class="form-control form-select" id="Print" name="Print" required disabled>
                            ...
                            <div class="col-md-6">
                                <div class="form-label{{ $errors->has('print_group') ? ' has-danger' : '' }}">
                                    ...
                                    <select class="form-control form-select" id="Mark_del" name="print_group" disabled>
                        ...
                        <input name="Print" type="hidden" value="{{ $keimeno->pivot->Print }}">
                        <input name="print_group" type="hidden" value="{{ $keimeno->pivot->print_group }}">
                        <input name="Note" type="hidden" value="{{ $keimeno->pivot->Note }}">
                        <div class="row mt-4">
