        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header-cust">
                    ...
                    <form id="edit_detail_ekth_nop_form" method="post" action="{{ route('pragmatognomosines.update_details_ekth',$id_ekthesis) }}" autocomplete="off">
                        @csrf
                        {{--                    {{ method_field('PUT') }}--}}
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-label{{ $errors->has('Cost_job') ? ' has-danger' : '' }}">
                                                ...
                                                <input type="number" name="Cost_job" id="Cost_job"
                                                       ...
                                                       value="{{ $detail->pivot->Cost_job }}"  autofocus required>
