...
@section('formsdetails')
    <form id="create_person_form" method="post" action="{{ route('person.store') }}" autocomplete="off">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                            ...
                            <div class="col-md-6">
                                <div class="form-label{{ $errors->has('id_person') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="id_person" id="id_person"
                                           ...
                                           value="{{ old('id_person') }}"   autofocus disabled>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-label{{ $errors->has('L_name') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="L_name" id="L_name"
                                           ...
                                           value="{{ old('L_name') }}" autofocus required>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-label{{ $errors->has('F_name') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="F_name" id="F_name"
                                           ...
                                           value="{{ old('F_name') }}" autofocus required>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-label{{ $errors->has('Father_name') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="Father_name" id="Father_name"
                                           ...
                                           value="{{ old('Father_name') }}" autofocus>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-label{{ $errors->has('Mother_name') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="Mother_name" id="Mother_name"
                                           ...
                                           value="{{ old('Mother_name') }}" autofocus>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-label{{ $errors->has('Age') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="Age" id="Age"
                                           ...
                                           value="{{ old('Age') }}" autofocus disabled>
                                </div>
                            </div>
                        </div>
                        <div class="row">
