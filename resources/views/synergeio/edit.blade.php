...
@section('formsdetails')
    <form id="create_synergeio_form" method="post" action="{{ route('synergeio.update', $synergeio->id_synergeia) }}" autocomplete="off">
        @csrf
        {{ method_field('PUT') }}
        <div class="row">
            <div class="col-md-12">
                            ...
                            <div class="col-md-4">
                                <div class="form-label{{ $errors->has('id_synergeia') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="id_synergeia" id="id_synergeia"
                                           ...
                                           value="{{ $synergeio->id_synergeia }}"   autofocus disabled>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-label{{ $errors->has('Name_syner') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="Name_syner" id="Name_syner"
                                           ...
                                           value="{{ $synergeio->Name_syner }}" autofocus required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-label{{ $errors->has('Addres') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="Addres" id="Addres"
                                           ...
                                           value="{{ $synergeio->Addres }}"   autofocus>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-label{{ $errors->has('Phone') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="Phone" id="Phone"  pattern="[0-9]{10}" maxlength="10"
                                           ...
                                           value="{{ $synergeio->Phone }}" autofocus required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-label{{ $errors->has('Kinito') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="Kinito" id="Kinito" maxlength="10" pattern="[0-9]{10}"
                                           ...
                                           value="{{ $synergeio->Kinito }}"   autofocus>
                                </div>
                            </div>
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                <div class="form-label{{ $errors->has('Email') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="email" name="Email" id="Email"
                                           ...
                                           value="{{ $synergeio->Email }}"   autofocus>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-label{{ $errors->has('Respon') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="Respon" id="Respon" maxlength="50"
                                           ...
                                           value="{{ $synergeio->Respon }}" autofocus>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-label{{ $errors->has('id_typos_synergeiou') ? ' has-danger' : '' }}">
                                    ...
                                    <select class="form-control form-select" id="id_typos_synergeiou" name="id_typos_synergeiou" required>
                                        <option value="1" @if($synergeio->id_typos_synergeiou ==1) selected="selected" @endif>Φανοποιείο</option>
                                        <option value="2" @if($synergeio->id_typos_synergeiou ==2) selected="selected" @endif>Ηλεκτρολογείο</option>
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-label{{ $errors->has('Mark_del') ? ' has-danger' : '' }}">
                                    ...
                                    <select class="form-control form-select" id="Mark_del" name="Mark_del" required>
                                        <option value="Ναι" @if($synergeio->Mark_del == 'Ναι') selected="selected" @endif>Ναι</option>
                                        <option value="Όχι" @if($synergeio->Mark_del == 'Όχι') selected="selected" @endif>Όχι</option>
                                    </select>
