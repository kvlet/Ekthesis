                    ...
                    <div class="container-fluid">
                        <div class="card">
                            <div class="card-body">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-label{{ $errors->has('phone') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="phone" id="phone"
                                                   ...
                                                   value="{{  $department->pivot->phone  }}" autofocus required disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-label{{ $errors->has('Fax') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="Fax" id="Fax"
                                                   ...
                                                   value="{{  $department->pivot->Fax  }}" autofocus disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-label{{ $errors->has('Email') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="email" name="Email" id="Email"
                                                   ...
                                                   value="{{  $department->pivot->Email  }}" autofocus disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-label{{ $errors->has('Respon') ? ' has-danger' : '' }}">
                                            ...
                                            <input type="text" name="Respon" id="Respon"
                                                   ...
                                                   value="{{  $department->pivot->Respon  }}" autofocus required disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                ...
                                <input name="phone" type="hidden" value=" {{ $department->pivot->phone  }}">
                                <input name="Fax" type="hidden" value=" {{ $department->pivot->Fax  }}">
                                <input name="Email" type="hidden" value=" {{ $department->pivot->Email  }}">
                                <input name="Respon" type="hidden" value=" {{ $department->pivot->Respon  }}">
                                <div class="row mt-4">
