...
@section('formsdetails')
    <form id="edit_expenses_oxima_form" method="post" action="{{ route('car_expen.update',$expen_oxima->id_expenses_oxima) }}" autocomplete="off">
        @csrf
        {{ method_field('PUT') }}
        <div class="row">
            <div class="col-md-12">
                            ...
                            <div class="col-md-4">
                                <div class="form-label{{ $errors->has('id_expenses_oxima') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="id_expenses_oxima" id="id_expenses_oxima"
                                           ...
                                           value="{{ $expen_oxima->id_expenses_oxima }}" disabled autofocus>
                            ...
                            <div class="col-md-4">
                                <div class="form-label{{ $errors->has('expen_date') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="expen_date" id="expen_date" data-provide="datepicker" data-date-format="dd-mm-yyyy" placeholder="HH-MM-YYYY"
                                           ...
                                           value="{{ $expen_oxima->expen_date }}" required>
                                ...
                                <div class="form-label{{ $errors->has('id_expen_oxima') ? ' has-danger' : '' }}">
                                    ...
                                    <select class="form-control form-select" id="id_expen_oxima" name="id_expen_oxima" required >
                                        ...
                                        @foreach($expen as $exp)
                                            <option value="{{$exp->id_expen_oxima}}" @if($expen_oxima->id_expen_oxima == $exp->id_expen_oxima) selected @endif>{{ $exp->expen_oxima }}</option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-md-4">
                                <div class="form-label{{ $errors->has('km') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="km" id="km"
                                           ...
                                           value="{{ $expen_oxima->km }}" autofocus>
                                    @if ($errors->has('km'))
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-md-4">
                                <div class="form-label{{ $errors->has('lt') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="lt" id="lt"
                                           ...
                                           value="{{ $expen_oxima->lt  }}" autofocus>
                                    @if ($errors->has('lt'))
                                        <span class="invalid-feedback" role="alert">
                            ...
                            <div class="col-md-4">
                                <div class="form-label{{ $errors->has('value') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="number" name="value" id="value"
                                           ...
                                           value="{{ $expen_oxima->value  }}" autofocus required>
                                    @if ($errors->has('value'))
                                        <span class="invalid-feedback" role="alert">
