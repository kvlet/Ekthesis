...
@section('formsdetails')
    <form id="create_esoda_oxima_form" method="post" action="{{ route('car_income.store') }}" autocomplete="off">
        @csrf
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                            ...
                            <div class="col-md-4">
                                <div class="form-label{{ $errors->has('id_esoda_oximatos') ? ' has-danger' : '' }}">
                                    ...
                                    <input type="text" name="id_esoda_oximatos" id="id_esoda_oximatos"
                                           ...
                                           value="{{ old('id_esoda_oximatos') }}" disabled autofocus>
                                </div>
                            </div>
                            <div class="col-md-4">
                                ...
                                <div class="form-label{{ $errors->has('id_accident_place') ? ' has-danger' : '' }}">
                                    ...
                                    <select class="form-control form-select" id="id_accident_place" name="id_accident_place" required >
                                        ...
                                        @foreach($accedent_places as $place)
                                            <option value="{{$place->id_accident_place}}" @if(old('id_accident_place') == $place->id_accident_place) selected @endif>{{ $place->Place }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-label{{ $errors->has('id_ekthesis') ? ' has-danger' : '' }}">
                                    ...
                                    <select class="form-control form-select" id="id_ekthesis" name="id_ekthesis" required >
                                        ...
                                        @foreach($ekthesis as $ekth)
                                            <option value="{{$ekth->id_ekthesis}}" @if(old('id_ekthesis') == $ekth->id_ekthesis) selected @endif>{{ $ekth->id_ekthesis }}</option>
                                        @endforeach
                                    </select>
